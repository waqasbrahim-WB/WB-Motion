...
# Generate button on the sidebar
...
with right_col:
    ...
    if generate:
        ...
        st.info("Motion display placeholder: This is where the 3D motion would be rendered.")
    else:
        st.warning("Select or enter a motion, then click 'Generate Motion' to preview.")

# Footer
st.caption("WB Motion — prototype build. Replace the placeholder with your 3D renderer when ready.")
